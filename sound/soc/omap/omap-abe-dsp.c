...
#include <../../../arm/mach-omap2/powerdomain.h>
#include <plat/prcm.h>
...
static const struct snd_soc_dapm_widget abe_dapm_widgets[] = {
	...
	SND_SOC_DAPM_MIXER("DL1 MM_EXT", ABE_WIDGET(41), ABE_OPP_25, 0,
			   &mm_ext_dl_switch_controls, 1),
...
static int aess_save_context(struct abe_data *abe)
{
	...
	dev_dbg(&pdev->dev, "saving ABE context\n");
